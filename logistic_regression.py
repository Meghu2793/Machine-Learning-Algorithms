...
initial_theta_1.shape
type(initial_theta_1)

initial_theta_0.shape
type(initial_theta_0)

initial_theta_0 = np.zeros(1)
initial_theta_1 = np.zeros(22)
initial_theta = 1.0 + np.concatenate((initial_theta_0, initial_theta_1))
...
writer = pd.ExcelWriter('sample.xlst')
